export class AppConfig {
    ...
    public static readonly AUTH_TOKEN = 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJlbnRpdHlJc' +
                                        '3N1ZXIiLCJpYXQiOjE1ODczNjc3MjcsImV4cCI6MTYxODkwMzcyNywiYXVkIjoiRXhhbXBsZSBhdXRob3JpemF0aW' +
                                        '9uIFRva2VuIiwic3ViIjoiaWRlbnRpdHlTdWJqZWN0In0.zujXluegmpfzWLqoFECL_X6h8gaRIHkQrg5kh9fvSyg';
    ...
    public static readonly basicTransaction = {
    ...
    public static readonly PSMHashReceiver = {
        psmhash: '0x8acea781ade3ec4d9528fdc1ce9a67c2e008f7ba9e80cb334514beb71447cffb',
        jwt: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ.eyJoZWFkZXIiOnsiYWxnIjoiRVMyNTZLIiwidHlwIjoiSldUIiwia2lkIjoiZ' +
            'GlkOmFsYTpxdW9yOnJlZHQ6UW1lZWFzQ1o5akxiWHVlQko3ZDdjc3hoYiNrZXlzLTEifSwicGF5bG9hZCI6eyJqdGkiOiJodHRwcz' +
            'ovL3d3dy5lbXByZXNhLmNvbS9hbGFzdHJpYS9jcmVkZW50aWFscy8zNzMyIiwiaXNzIjoiZGlkOmFsYXN0cmlhOnF1b3J1bTpyZWR0Ol' +
            'FtZWVhc0NaOWpMYlguLi51ZUJKN2Q3Y3N4aGIiLCJhdWQiOiJkaWQ6YWxhc3RyaWE6cXVvcnVtOnJlZHQ6UW1lZWFzQ1o5akxiWC4uLn' +
            'VlQko3ZDdjc3hoYiIsImlhdCI6MTU3MTkwODIwOCwiZXhwIjoxNTMwNzM1NDQ0LCJuYmYiOjE1MjU0NjUwNDQsInZwIjp7IkBjb250ZXh0I' +
            'jpbImh0dHBzOi8vd3d3LnczLm9yZy8yMDE4L2NyZWRlbnRpYWxzL3YxIiwiSldUIl0sInR5cGUiOlsiVmVyaWZpYWJsZVByZXNlbnRhdGlvb' +
            'iJdLCJwcm9jVXJsIjoiaHR0cHM6Ly93d3cuZW1wcmVzYS5jb20vYWxhc3RyaWEvYnVzaW5lc3Nwcm9jZXNzLzQ1ODMiLCJwcm9jSGFzaCI6Ikg' +
            'zOThzakhkLi4ua2xkalVZbjQ3NW4iLCJ2ZXJpZmlhYmxlQ3JlZGVudGlhbCI6W3t9XX19fQ.CDkCzzhkHqVoXghuZVX9f_YYBszo0_WydqGmIhcp' +
            '1d2iIvu-F9DRcbYgimM5dICUwE0Ec66mEkeKNlaXDt73Mg'
    };
    public static readonly PSMHashSubject = {
        psmhash: '0x16c32ee43fd4fb89fde577f062e4a40e8067136cd6ca16175bf00b50079cf844',
        jwt: AppConfig.PSMHashReceiver.jwt
    };
